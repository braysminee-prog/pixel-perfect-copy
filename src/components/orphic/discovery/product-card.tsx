    ...
    <article className="group">
      <div className="relative aspect-square overflow-hidden rounded-2xl bg-card">
        ...
        <button
          ...
          aria-pressed={loved}
          className="absolute right-2.5 top-2.5 flex size-9 items-center justify-center rounded-full orphic-glass text-foreground/80 transition-colors duration-300 hover:text-foreground"
        >
          <Heart
